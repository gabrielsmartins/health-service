...
@Component
public class BloodPressureMeasurementAnalyzer extends MeasurementAnalyzer {

    public BloodPressureMeasurementAnalyzer(SaveMeasurementUseCase saveMeasurementUseCase) {
        super(saveMeasurementUseCase);
    }

    @Override
    protected boolean isHighLevel(Measurement measurement) {
        return measurement.getValue() > 120.80;
    }

    @Override
    protected boolean isLowLevel(Measurement measurement) {
        return measurement.getValue() < 100.60;
    }
